/*
Ahmet Yaylalioglu
https://github.com/ahmetyaylalioglu/Estimation-of-the-number-of-real-time-hand-fingers-with-image-processing
10.02.2017
*/
...
int main(){
	...
	while (1)
	{
		Mat aynali2;
		cap >> originalFrame;
		cv::flip(originalFrame, aynali, 1);
		cv::rectangle(originalFrame, cv::Point(300, 300), cv::Point(12, 12), cv::Scalar(0, 0, 255));
		...
		threshold(griGoruntu, or2, thresh, maxVal, THRESH_OTSU + THRESH_BINARY_INV);
